...
if  verlt $(fzf --version | cut -d " " -f 1) 0.16.3; then
    echo "Please update your FZF version."
    echo "cd ~/.fzf && git pull && ./install"
    export FZF_COMPLETION_OPTS="--select-1 $FZF_COMPLETION_OPTS --bind=tab:accept"
else
    export FZF_COMPLETION_OPTS="--height 40% --select-1 $FZF_COMPLETION_OPTS --bind=tab:accept"
fi
